  ...
  <form  method="post"  id="video" enctype="multipart/form-data">
   ...
   <div class="form-group">
     ...
     <div class="form-group">
      ...
      <input name="publish" type="date" class="form-control"  placeholder="" >
    </div>
                	  ...
                	  // $("#submit").prop("disabled", true);
                       $.ajax({
                           ...
                           success: function (data) {
                             //  alert(data);
                        	   $( "#message" ).html( "<p class='alert alert-success'><strong>" + data + "</strong></p>" );  
	...
	$().ready(function() {
		...
		$("#video").validate({
			...
			messages: {
				...
				logo: "Please Select Video",
                video_description: "Please enter video description",
                publish: "Select Publish Date",
				username: {
