...
abstract class REST_Controller extends CI_Controller {
    ...
    /**
     * The LDAP Distinguished Name of the User1 post authentication
     *
     * @var string
     */
    ...
    protected function _perform_ldap_auth($username = '', $password = NULL)
    {
        ...
        {
            log_message('error', 'LDAP Auth: User1 '.$username.' not found in search');
            return FALSE;
        }
        ...
        // User1 found, could not authenticate as user
